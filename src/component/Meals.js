    ...
    <div className="max-w-[1520px] m-auto px-4 py-12">
      ...
      <div className="flex flex-col lg:flex-row justify-center">
        <div className="flex justify-center md:justify-center">
          ...
          className="m-1 border-orange-700 text-white bg-orange-700 hover:bg-white hover:text-orange-700 rounded-[5px] hover:border-orange-700 w-[60px]">
            All
          </button>
          <button
           onClick={()=>fillterCat("pizza")}
          className="m-1  text-white bg-orange-700 hover:bg-white hover:text-orange-700 hover:border-orange-700 rounded-[5px] w-[60px] ">
            Pizza
          </button>
          <button 
